...
} from "../services/ingestBuild.js";
import type { BuildSource } from "../types.js";
...
const WEBHOOK_SOURCES = new Set<string>(["github", "jenkins"]);
...
router.post(
  ...
  async (req: Request, res: Response): Promise<void> => {
    ...
    const source = rawSource as BuildSource;
